...
namespace Wiwa {
	...
	void Button::Update()
	{
		...
		if (Input::GetMousePosition().first > m_Bounds.x && Input::GetMousePosition().first < m_Bounds.x + m_Bounds.width
			&& Input::GetMousePosition().second > m_Bounds.y && Input::GetMousePosition().second < m_Bounds.y + m_Bounds.height)
		{
